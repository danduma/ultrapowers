...
export const UltrapowersPlugin = async () => {
...
**IMPORTANT: The using-ultrapowers skill content is included below. It is ALREADY LOADED. Do NOT use the skill tool to load "using-ultrapowers" again.**
...
export default UltrapowersPlugin;
